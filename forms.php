...
<html lang="en">
    ...
    <meta name="author" content="Anshul Yadav"/>

    <link rel="stylesheet" type="text/css" href="me1170565/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.0.13/css/all.css"
          integrity="sha384-DNOHZ68U8hZfKXOrtjWvjxusGo9WQnrNx2sqG0tfsghAvtVlRW3tvkXWZh58N9jp" crossorigin="anonymous">
    <link rel="stylesheet" href="me1170565/style.css" type="text/css"/>
       <!-- Favicons
        ================================================== -->
    <link rel="shortcut icon" href="me1170565_images/bsw.ico" type="image/x-icon">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. <br />
			 ...
			 <section id="main"  style="margin-top: 90px;padding-bottom: 40px;">
				<div class="container" >
...
<script src="me1170565/js/bootstrap.min.js"></script>
<script src="me1170565/js/scrollreveal.min.js"></script>
...
<script>
    ...
    sr.reveal('.img2', {duration: 700});
    sr.reveal('.img3', {duration: 700});
    $('.carousel').carousel({
        pause: "false"
    });
</script>
...
<script src="kc.fab.min.js"></script>
        <script>
            $(document).ready(function(){
                var links = [
                    {
                    ...
                    {
                        "url":"https://www.facebook.com/boardforstudentwelfare/",
                        "bgcolor":"#3B5998",
                        "color":"#fffff",
                    ...
                    {
                        "url":"mailto:Bsw.Gsec.student_admins@admin.iitd.ac.in",
                        "bgcolor":"red",
                        "color":"white",
                        "icon":"<i class='far fa-envelope'></i>"
                    },
                    {
                        "url":"http://bsw.iitd.ac.in/interns.php",
                        "bgcolor":"green",
                        "color":"white",
